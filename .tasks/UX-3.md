...
- [ ] P1-A 停摆/未启动空状态引导：stopped / paused 时说明「怎么把循环跑起来」
- [ ] P1-B 浮窗可访问性闭环：`role="dialog"` + Esc 关闭 + 焦点移入/恢复 + ✕ 标签
- [ ] P1-C 团队切换失败反馈：网络/非 2xx 不再静默弹回，给可见提示
- [ ] P1-D 看板过滤一键清除：有效过滤态提供「清除过滤」复位，不必逐项手清
