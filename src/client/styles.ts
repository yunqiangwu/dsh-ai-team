...
/* ── 紧凑重构: body padding 16→12, gap 12→8 ── */
.dsh-ai-team__body { padding: 6px 12px 10px; display: flex; flex-direction: column; gap: 8px; max-height: min(42vh, 480px); min-height: 96px; overflow-y: auto; resize: vertical; }
...
.dsh-ai-team__kanban { columns: 200px; column-gap: 8px; }
.dsh-ai-team__column { break-inside: avoid; page-break-inside: avoid; margin-bottom: 8px; border: 1px solid rgba(127,127,127,.2); border-radius: 8px; padding: 4px; max-height: 320px; overflow-y: auto; }
.dsh-ai-team__column-title { display: flex; justify-content: space-between; margin: 0 0 4px; font-size: 11px; opacity: .75; position: sticky; top: 0; background: inherit; z-index: 1; }
/* ── 紧凑重构: card padding 5/6→3/4, meta 10pt→9pt, margin-bottom 6→4 ── */
.dsh-ai-team__card { position: relative; display: flex; flex-direction: column; gap: 1px; padding: 3px 4px; border-radius: 6px; background: rgba(127,127,127,.12); margin-bottom: 4px; }
...
.dsh-ai-team__board-head { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
...
.dsh-ai-team__stats { width: 100%; display: flex; align-items: center; gap: 4px; padding: 2px 0; overflow-x: auto; }
...
.dsh-ai-team__guide { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; padding: 6px 8px; border: 1px solid rgba(234,179,8,.45); border-left: 3px solid #eab308; background: rgba(234,179,8,.08); border-radius: 8px; }
...
.dsh-ai-team__summary-card { display: flex; flex-direction: column; gap: 4px; padding: 6px 8px; border: 1px solid rgba(34,197,94,.45); border-left: 3px solid #22c55e; background: rgba(34,197,94,.08); border-radius: 8px; }
...
.dsh-ai-team__async-banner { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; padding: 6px 8px; border: 1px solid rgba(234,179,8,.45); border-left: 3px solid #eab308; background: rgba(234,179,8,.08); border-radius: 8px; }
...
.dsh-ai-team__alert { position: absolute; top: 15px; right: 42px; z-index: 30; display: inline-flex; align-items: center; justify-content: center; width: 24px; height: 24px; padding: 0; border: 1px solid rgba(127,127,127,.35); border-radius: 50%; background: transparent; color: inherit; cursor: pointer; }
