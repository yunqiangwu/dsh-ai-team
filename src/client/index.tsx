...
export const zh = {
  ...
  'questionnaires.empty': '没有在等人回答的问题',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'section.questionnaires': 'Waiting for you',
  ...
  'questionnaires.empty': 'No questions waiting for an answer',
